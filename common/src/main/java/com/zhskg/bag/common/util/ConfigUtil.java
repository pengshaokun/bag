...
//
//    //.bin 文件位置
//    public static String BIN_ABSOLUTE_DISK_PATH = config.getString("BIN_ABSOLUTE_DISK_PATH");
//    public static String BIN_RELATIVE_DISK_PATH = config.getString("BIN_RELATIVE_DISK_PATH");
//    public static String BIN_ABSOLUTE_LINUXDISK_PATH = config.getString("BIN_ABSOLUTE_LINUXDISK_PATH");
//
//
//}
//
