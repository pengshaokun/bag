...
//    }
    ...
    @Override
    public void stringSetValueAndExpireTime(String key, String value, long timeout,TimeUnit timeUnit) {
        redisTemplate.opsForValue().set(key, value, timeout,timeUnit);
    }

    @Override
    public Boolean setMapAndExpireTime(String key,Map<String,Object> map,long timeout, TimeUnit unit){
...
//         return redisTemplate.opsForHash(key,object);
//    }
